...
# Paths
	export PATH=$HOME/.local/bin:$HOME/.local/share/gem/ruby/3.3.0/bin:/snap/bin:/usr/sandbox/:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/share/games:/usr/local/sbin:/usr/sbin:/sbin
